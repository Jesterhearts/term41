...
fn history_deletion_view(entries: Vec<history41::StoredHistoryEntry>) -> HistoryDeletionView {
    let entries = entries
        .into_iter()
...
fn scroll_history_deletion_view(
    view: &mut HistoryDeletionView,
    delta: isize,
    visible_rows: usize,
) {
...
pub(crate) struct InputState {
    ...
    history_confirmation: Option<HistoryConfirmationView>,
    history_deletion: Option<HistoryDeletionView>,
